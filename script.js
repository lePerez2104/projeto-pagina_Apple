...
// Listas de opções de cores e tamanhos
const opcoesCores = [verdeCipreste, azulInverno, meiaNoite, estelar, rosaClaro];
const opcoesTamanho = ['41mm', '45mm'];

// Fixar imagem (miniatura), tamanho e cor quando a página for aberta
let imagemSelecionada = 1;
let tamanhoSelecionado = 1
let corSelecionada = 1;

// Função para trocar a imagem em miniatura selecionada
...
// Função para trocar o tamanho selecionado
